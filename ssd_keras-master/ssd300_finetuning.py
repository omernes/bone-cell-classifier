...
# VOC_2007_trainval_image_set_filename = getenv('IMAGESET_TRAINVAL_2007',
#                                               'datasets/VOCdevkit/VOC2007/ImageSets/Main/trainval.txt')
# VOC_2012_trainval_image_set_filename = getenv('IMAGESET_TRAINVAL_2012',
#                                               'datasets/VOCdevkit/VOC2012/ImageSets/Main/trainval.txt')
